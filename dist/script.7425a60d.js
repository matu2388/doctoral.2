...
document.addEventListener("DOMContentLoaded", function () {
  var mymap = new L.map('map').setView([0, 0], 13);
  ...
  _sitios.sitios.forEach(function (point) {
    var markerInstance = marker([point.lat, point.lon]).addTo(mymap);
...
},{"../../dist/assets/data/markers/sitios":"dist/assets/data/markers/sitios.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
